...
S := Scheme(AY, eqns cat [norm2^2 - 1, TrY2 - 1]);

S3 := Scheme(AY, eqns cat eqns3 cat [norm2^2 - 1, TrY2 - 1]);
S4 := Scheme(AY, eqns cat eqns4 cat [norm2^2 - 1, TrY2 - 1]);
S34 := Scheme(AY, eqns cat eqns3 cat eqns4 cat [norm2^2 - 1, TrY2 - 1]);
